...
public class WsnGraph {    
    ...
    // retorna 0;
    public static int getNumberOfUndirectedGraphs(ArrayList<Sensor> relayNodeVertexSet) {
        ...
        int numberOfUndirectedGraphs = graphVertexList.size() - numberOfSpannigTreeEdges;
        
        if (numberOfUndirectedGraphs == 1) {
            return 0;
        }
        else {
            return numberOfUndirectedGraphs;
        }
    }
}
